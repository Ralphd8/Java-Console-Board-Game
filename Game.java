...
public class Game {
    ...
    static{
        System.out.println("Weclome to the game!");
        ...
        System.out.println(player2_name + ", you will sit in the " + player2_position + ", and your peice shape is: " + player2_pieceShape);
    ...
    public static void main(String[] args){
        ...
        do{
            ...
            do{
                ...
                grid.drawGrid();
                System.out.println(playerTurn.name + " it's your turn!");
                System.out.println(playerTurn.name + " please choose the piece you want to move.");
                ...
                System.out.println(playerTurn.name + " please choose where you want to move this piece.");
                System.out.println("Enter X coords:");
                destX = obj.nextInt();
                System.out.println("Enter Y coords:");
                destY = obj.nextInt();
                ...
                if(move.acceptableMove == false){
                    System.out.println("Restricted move, please retry again");
                }

            }while(move.acceptableMove == false);

            if(move.keepPlaying ==false){
